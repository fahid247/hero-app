...
const InstalledApp = ({card , handleRemove}) => {
    ...
    return (
        <div className='max-w-[1440px] mx-auto p-4'>
            <div className='bg-white  flex justify-between rounded-lg h-[min(10vw,122px)] mb-4 p-1 md:p-3 lg:p-5'>
            <div className='flex gap-4'>
                ...
                <div>
                    ...
                    <div className='flex gap-4 items-center text-center text-[min(1.5vw,16px)] mt-1 sm:mt-4'>
                        <p className='flex items-center text-[rgba(0,211,144,1)]'><FaDownload></FaDownload>{card.downloads}</p>
