    ...
    return (
        <div className='bg-white h-[100%] rounded-2xl shadow-[0px_10px_20px_rgba(0,0,0,0.1)] p-4'>
            ...
            <div className='flex justify-between mt-4'>
                <div  className='bg-[rgba(241,245,232,1)] p-1 sm:p-2 px-2 sm:px-4 rounded-2xl text-[rgba(0,211,144,1)] flex items-center justify-center gap-1 text-[min(2vw,16px)]'><FaDownload /><h1>{card.downloads}</h1></div>
